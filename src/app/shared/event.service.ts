...
export class EventService {
  ...
  refreshList() {
    this.http
      .get(this.baseURL + '/Event/GetEvents')
      .toPromise()
  ...
  eventsList(): Observable<Event[]> {
    return this.http
      .get(this.baseURL + '/Event/GetEvents')
      .pipe(map((res) => (this.list = res as Event[])));
  }

  getOne(id: any) {
    return this.http
      .get(this.baseURL + '/Event/GetEvents/' + id)
      .toPromise()
  ...
  profileEvents(body: any) {
    this.http
      .post(this.baseURL + '/Event/ProfileEvents', body)
      .subscribe((res: any) => {
        this.profileShowEvents = res as Event[];
      });
  }

  profileEventsObservable(body: any): Observable<Event[]> {
    return this.http
      .post(this.baseURL + '/Event/ProfileEvents', body)
      .pipe(map((res) => (this.temp = res as Event[])));
  }

  createdEventsObservable(body: any): Observable<Event[]> {
    return this.http
      .post(this.baseURL + '/Event/CreatedEvents', body)
      .pipe(map((res) => (this.createdList = res as Event[])));
  }
  ...
  deleteEvent(body:any){
    this.http.post(this.baseURL+"/Event/DeleteEvent", body).subscribe(
      (res:any) =>{
        if(res.message == "Event deleted succesfully."){
  ...
  buttonStatus(body: any) {
    this.http
      .post(this.baseURL + '/Event/ButtonStatus', body)
      .subscribe((res: any) => {
